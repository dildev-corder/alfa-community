"""Train a tabular landslide-risk classifier and export TensorFlow Lite.

CSV columns: rainfall_72h, slope_degrees, soil_moisture_percent, risk_label
...
FEATURES = ["rainfall_72h", "slope_degrees", "soil_moisture_percent"]


def main() -> None:
    parser = argparse.ArgumentParser()
    parser.add_argument("--csv", required=True, type=Path)
    parser.add_argument("--output", default=Path("landslide_model.tflite"), type=Path)
